...
test('trunc', () => {
  ...
  expect(Math.trunc(new Irrational('3.456')).toString()).toBe('3');
...
test('ceil', () => {
  ...
  expect(Math.ceil(new Irrational('3.456')).toString()).toBe('4');

  expect(Math.ceil(-1.234).toString()).toBe('-1');
  expect(Math.ceil(-3n).toString()).toBe('-3');

  expect(Math.ceil(new Rational('-1.234')).toString()).toBe('-1');
  expect(Math.ceil(new Irrational('-3.456')).toString()).toBe('-3');
});
...
test('floor', () => {
  ...
  expect(Math.floor(new Irrational('3.456')).toString()).toBe('3');

  expect(Math.floor(-1.234).toString()).toBe('-2');
  expect(Math.floor(-3n).toString()).toBe('-3');

  expect(Math.floor(new Rational('-1.234')).toString()).toBe('-2');
  expect(Math.floor(new Irrational('-3.456')).toString()).toBe('-4');
});
