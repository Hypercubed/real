...
test('integers', () => {
  expect(	sqrt(	'25'	    ).toFixed(2)).toBe(	'5.00'	);
  expect(	sqrt(	'16'	    ).toFixed(2)).toBe(	'4.00'	);
  expect(	sqrt(	'9'	      ).toFixed(2)).toBe(	'3.00'	);
  expect(	sqrt(	'4'	      ).toFixed(2)).toBe(	'2.00'	);
  expect(	sqrt(	'1'	      ).toFixed(2)).toBe(	'1.00'	);
