...
test('atanh', () => {
                                                  // 5.49306
  expect(atanh('0.5000'          ).toString()).toBe('5.493e-1');

                                                         // 1.00335347731075580635726552060038945263362869145959135874
  expect(atanh('0.1000'                 ).toString()).toBe('1.003e-1');
...
test('zeros', () => {
  expect(atanh(0n             ).toString()).toBe('0');
  expect(atanh('0.0000'       ).toString()).toBe('0.e-4');
