...
test('floor', () => {
  ...
  expect(floor(9007199254740992n).toString()).toBe('9.007199254740992e+15');
  expect(floor(9007199254740994n).toString()).toBe('9.007199254740994e+15');
  expect(floor(10_000_000_000_000_000n).toString()).toBe('1.0000000000000000e+16');
