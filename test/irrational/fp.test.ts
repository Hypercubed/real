...
test('fp', () => {
  ...
  expect(fp(9007199254740992n).toString()).toBe('0.000000000000000e+0');
  expect(fp(9007199254740994n).toString()).toBe('0.000000000000000e+0');
  expect(fp(10_000_000_000_000_000n).toString()).toBe('0.0000000000000000e+0');
