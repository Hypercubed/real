...
test('add', () => {
  ...
  // expect(add('1.0', '2.' ).toString()).toBe('3.e+0');  // precision bug
  expect(add('1.',  '2.0').toString()).toBe('3.e+0');
  expect(add('1.0', '2.0').toString()).toBe('3.0e+0');

  // expect(add('0.10', '0.2').toString()).toBe('3.e-1');  // precision bug
  ...
  expect(Irrational.TWO.add(new Irrational(1)).toString()).toBe('3.00000000000000e+0');
  expect(new Irrational(1).add(Irrational.TWO).toString()).toBe('3.00000000000000e+0');
});
