...
test('exp', () => {
  ...
  expect(exp( 1    ).toString()).toBe('2.e+0');
  expect(exp('1.0' ).toString()).toBe('2.7e+0');
  expect(exp('1.00').toString()).toBe('2.70e+0');  // TODO: numeric bug

                                      // 7.389056098930650227230427460575007813180315570551847324087
  expect(exp( 2      ).toString()).toBe('6.e+0');
  expect(exp('2.0'   ).toString()).toBe('7.3e+0');
  expect(exp('2.0000').toString()).toBe('7.3345e+0');  // TODO: numeric bug
  ...
  expect(exp('-1.0000').toString()).toBe('3.7447e-1'); // TODO: numeric bug
});
