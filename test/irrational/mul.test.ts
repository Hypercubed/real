...
test('basic zeros', () => {
  expect(mul('1.20',   '0').toString()).toBe( '0');
  expect(mul('-1.20',  '0').toString()).toBe( '0');

  expect(mul('1.20',  '0.00' ).toString()).toBe( '0.e-2');
  expect(mul('-1.20',  '0.00').toString()).toBe( '0.e-2');
});
...
test('mul', () => {
  ...
  expect(mul('9007199254740992.', 2                    ).toString()).toBe('1.801439850948198e+16');
  expect(mul('9007199254740992.', '2.'                 ).toString()).toBe('1.8e+16');  
  expect(mul('9007199254740992.', '2.00000000000000000').toString()).toBe('1.8014398509481984e+16');
