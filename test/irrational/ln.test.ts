...
test('ln', () => {
  ...
  expect(ln(2n).toString()).toBe('7.e-1');
  ...
  expect(ln(Irrational.E).toString()).toBe('0.e+1');  // TODO: bug!!  (1.0)

  expect(ln(9007199254740992n).toString()).toBe('3.700000000000000e+1');  // TODO: bug!!
                                             //  3.673680056967710139911330243728335810800150712109352846839e+1
  expect(ln('9007199254740992e11').toString()).toBe('6.300000000000000e+1');  // TODO: bug!!
