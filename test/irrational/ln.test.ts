...
test('basics', () => {
  // expect(	ln	(	'1.000000000e-9'	).toString()).toBe(	'-2.07232658369e+1'	);  // TODO: slow
  // expect(	ln	(	'0.000700000'	    ).toString()).toBe(	'-7.2644302229e+0'	);  // TODO: slow
  ...
  expect( ln  (  10n          ).toExponential(5)).toBe( '2.30259e+0');
