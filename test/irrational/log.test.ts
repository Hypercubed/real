...
test('basics', () => {
  expect(	log	(	'7.00000000000E-1000'	).toString()).toBe(	'-9.9915490196e+2'	); // TODO: presision??
  ...
  // expect(	log	(	'2.718281828459045'	).toString()).toBe(	'4.342944819e-1'	); // TODO: value bug!!
  ...
  expect(	log	(	'7.00000000000E+1000'	).toString()).toBe(	'1.00084509804e+3'	);   // precision!!
});
...
test('log(2) constants', () => {
  // expect(	log	(	'2'	      ).toString()).toBe(	'3.01029995663981195213738894724493026768189881462108541309e-1'	); // slow
...
test.skip('log(E) constants', () => {
  // expect(Irrational.LOG10E.toString()   ).toBe('4.34294481903251827651128918916605082294397005803666566114e-1');
  // expect(log(Irrational.E).toExponential(5)).toBe('4.342944819032518.e+0');  // TODO: bug!!
