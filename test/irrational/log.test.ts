...
test.skip('log', () => {
  ...
  expect(log(1)).toBe('0.e+0');
  expect(log(10)).toBe('1.0e+0');
  expect(log(100)).toBe('2.00e+0');

  expect(log(100000)).toBe('5.0000000000000000000e+0');

  expect(log(2)).toBe('3.0102999566398119532e-1');
             // 0.3_01029995663981195213738894724493026768189881462108541310

  expect(log(2718)).toBe('3.4342494523964755067e+0');
                  // 3.434249452396475506672867756572026433614541038620377722067

  expect(log(Irrational.E)).toBe('4.3429448190325182769e-1');
