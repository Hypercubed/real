...
test('pow10', () => {
  ...
  expect(pow10('200.').toString()).toBe('1.0e+200');
});

test('negitive', () => {
  expect(pow10(-1).toString()).toBe('1.00000000000000e-1');
  expect(pow10(-2).toString()).toBe('1.00000000000000e-2');  // error

  expect(pow10('-1.').toString()).toBe('1.0e-1');
  expect(pow10('-2.').toString()).toBe('1.0e-2'); 
  expect(pow10('-200.').toString()).toBe('1.0e-200'); // ??
});
...
test('zeros', () => {
  ...
  expect(pow10('0.').toString()).toBe('1.0e+0');
  expect(pow10('0.00').toString()).toBe('1.00e+0');

  expect(pow10('0.00e5').toString()).toBe('0.e+2'); // ??
});