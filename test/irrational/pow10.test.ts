...
test('exact', () => {
  ...
  // expect(pow10(100n).toString()).toBe('1.e+200');  // ??

  expect(pow10(-1).toString()).toBe('1.00000000000000e-1');  // ??
  expect(pow10(-2).toString()).toBe('1.000000000000001e-2');
});

test('fractions', () => {
                                          // 1.023292992280754130966275174819877827341164057237981308599
  expect(pow10('0.01'    ).toString()).toBe('1.e+0');
  expect(pow10('0.0100'  ).toString()).toBe('1.02e+0');
  expect(pow10('0.010000').toString()).toBe('1.0233e+0');  
});
